// src/components/inventory/InventoryHero.tsx
"use client";
  ...
  return (
    <div className="relative z-10 flex flex-col items-center text-center px-4 pt-28 pb-14 sm:pt-32 sm:pb-16">
      ...
      >
        ...
        <span className="text-sm font-medium text-white/80">15,000+ Vehicles Available</span>
      </motion.div>
      ...
      >
        Browse Our <span className="text-[#FC5E01]">Vehicle Inventory</span>
      </motion.h1>
      ...
      >
        Search thousands of vehicles from verified dealerships across the country.
      </motion.p>
