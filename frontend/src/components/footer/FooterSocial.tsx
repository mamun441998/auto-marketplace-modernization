...
export default function FooterSocial() {
  return (
    <div>
      <h4 className="mb-4 text-sm font-semibold tracking-wider text-white">Follow Us</h4>
      <div className="flex gap-4">
        {socialLinks.map((social, index) => (
          <Link
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full border border-[#1e2a4a] text-white transition-all hover:border-[#AA4D20] hover:text-[#AA4D20]"
          >
